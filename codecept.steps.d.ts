...
type ICodeceptCallback = (i: CodeceptJS.I, DefaultUser:any, SettingsPage:any) => void;
...
declare namespace CodeceptJS {
  export interface I {
    ...
    debug(msg: string) : void,
    debugSection(section: string, msg: string) : void,
    verifyColumnValuesContainsText(locator: ILocator, text: string) : void,
    verifyColumnValuesContainsText(locator: string, text: string) : void,
    getRowColNum(locator: ILocator, header: string) : void,
    getRowColNum(locator: string, header: string) : void,
    GetRowColNum(locator: ILocator, header: string) : void,
    GetRowColNum(locator: string, header: string) : void,
  ...
  export interface SettingsPage {
    ...
    () : void,
    clickEditbutton(rowNum: string, colNum: string) : void,
